...
console.log(account.deposit(500));
 ...
 console.log(`Всего снято денег со счета: ${account.getTransactionTotal('withdraw')}`);
 console.log(`Всего добавлено денег на счет: ${account.getTransactionTotal('deposit')}`);
